...
class IFrameManager {
  ...
  sendMessage(message, callback) {
    ...
    const prefix = `[calling-extensions-sdk@${version}] To HubSpot`;
    this.logDebugMessage(prefix, type, message);
  ...
  onMessage(event) {
    ...
    const prefix = `[calling-extensions-sdk@${version}] From HubSpot`;
    this.logDebugMessage(prefix, type, { data });
